...
const services = [
  {
    n:'01', name:'单次咨询诊断', stage:'解决一个具体卡点', price:'¥399 / 次', badge:'低成本试错', featured:false,
    for:'已经在做账号，但卡在流量、定位、内容或转化其中一环的人。',
    cardItems:['2小时 1v1 深度咨询','3–5个优先动作','72小时内书面报告'],
    problems:['账号做了一段时间，但不知道问题出在哪里','内容发了很多，但没有明确获客路径','知道要做 IP，却不知道自己适合什么人设','想先判断双方是否适合长期合作'],
    approach:'通过 2 小时 1v1 视频或语音，深度梳理账号现状、目标客户、内容方向和转化卡点。咨询结束后，我们会给出可执行的诊断建议，明确你现在最应该先改定位、改内容，还是改承接链路。',
    deliverables:['1次2小时深度咨询','账号定位初步判断','内容方向建议','当前最优先解决的3–5个动作','咨询后72小时内交付书面诊断报告'],
    footnote:'这是最低成本的试错产品。通过这次咨询，我们基本可以判断双方是否适合进入下一步合作。'
  },
  {
    n:'02', name:'月度内容顾问', stage:'持续校准内容方向', price:'¥4,000 / 月', badge:'轻陪伴', featured:false,
    ...
    approach:'每月提供2次1v1内容顾问服务，围绕账号定位、选题规划、内容复盘、投放建议和转化链路持续校准。你负责执行，我们负责判断方向、复盘结果和调整动作。',
    deliverables:['每月2次1v1咨询','每月1份内容复盘报告','账号选题库共建','每月内容方向校准','阶段性投流和转化建议'],
    footnote:'适合想自己做，但不想闭门造车的人。'
  },
  {
    n:'03', name:'线上陪跑体系', stage:'从0到1搭建获客系统', price:'¥16,800 / 3个月', badge:'核心产品', featured:true,
